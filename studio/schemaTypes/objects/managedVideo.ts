...
export const managedVideo = defineType({
  ...
  fields: [
    ...
    defineField({
      ...
      description:
        "Upload reviewed WebVTT captions. Do not upload unreviewed automatic captions.",
    }),
    defineField({
      name: "transcript",
      ...
      description:
        "Leave empty until a human-reviewed transcript is available.",
    }),
    defineField({
      name: "autoplay",
      title: "Autoplay",
    ...
    defineField({
      ...
      validation: (rule) =>
        rule.custom((value, context) =>
          !(context.parent as { autoplay?: boolean })?.autoplay ||
          value === true
            ? true
